...
def page_rank(matrix, taxation=False, b=1, Es=[], S=set(), nbr_iterations=10000000, verbose=False):
    ...
    if S and taxation:
        ...
        taxation_v = (1-b)/elements_length * mat(ones((elements_length,1))) if taxation else mat(ones((elements_length,1))) * 0
...
def test_page_rank_advanced():
    m = matrix([[0,0.5,0,0],[1/3,0,0, 0.5],[1/3,0,1,0.5], [1/3, 0.5, 0,0]])            
    P = tuple((tuple(('1', '2', '3', '4')), tuple(('0', '6', '7', '8')), tuple(('2', '5', '9', '10')), tuple(('2', '5', '9', '10', '0'))))
